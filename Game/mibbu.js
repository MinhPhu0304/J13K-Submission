...
var mibbu = function(Cwidth, Cheight, _parent){
    ...
    **/
    ...
    var MeasureFPS = function () {
        ...
        if (typeof currentScore == "undefined") {
            printOut += "Meteor avoided : 0";
        }
        else {
            printOut = "Meteor Avoided: " + currentScore;
        }
        //printOut += stringFps;
        printOut = printOut.fontcolor('white');

        if (MB_usingCanvas) {
            MB_mainContext.fillStyle = "red";
            //MB_mainContext.font = "12px Arial";
            MB_mainContext.fillText(stringFps, 4, 15);

        } else {
            if (MB_ftpsDiv) {
                MB_ftpsDiv.innerHTML = printOut;
            }
        }
        frameCount++;
    };
    ...
    */
    ...
    return {
        //config
        'showScore': function() {MB_fpsMeasure=true; return this;},
        ...
        'changeText': function (textInput) {
            currentScore = textInput;
        },
